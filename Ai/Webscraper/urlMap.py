class UrlMapClass:
    ...
    urlmap = {'google':'https://www.google.com',
              ...
              'llama_replicate':'https://www.llama2.ai/',
              }
...
class XPaths:
    xpaths = {'search':'//*[@id="input"]',
              ...
              'llama_input':'/html/body/main/footer/div/form/textarea',
              'llama_answers':'/html/body/main/article/div[2]',
            #   '/html/body/main/article/div[4]'
            #   '/html/body/main/article/div[last()]'
              }